...
func writeImageReader(u *model.User, imageName string, hash uint64, dec io.Reader, ct string, cb chan error) string {
	path := "tmp/images/"
...
func writeAvatar(u *model.User, bg bool, image string) (string, error) {
